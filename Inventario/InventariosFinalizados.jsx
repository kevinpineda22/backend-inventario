                  ...
                  <table className="if-table">
                    ...
                    <tbody>
                      {comparacionFiltrada.length === 0 ? (
                        <tr><td colSpan="8">{filtroItem ? "No se encontraron items que coincidan con el filtro." : "No hay datos para mostrar."}</td></tr>
                      ) : (
                        comparacionFiltrada.map((item, i) => (
                          <tr key={item.item || `comp-${i}`}>
                            ...
                            {/* ✅ NUEVAS CELDAS: Conteos por ubicación */}
                            <td style={{ backgroundColor: '#e3f2fd', fontWeight: 'bold' }}>
                              {mostrarConComa(item.conteo_punto_venta || 0)}
                            </td>
                            <td style={{ backgroundColor: '#fff3e0', fontWeight: 'bold' }}>
                              {mostrarConComa(item.conteo_bodega || 0)}
                            </td>

                            {/* ✅ CELDA: 1er Conteo Físico (suma de PV + Bodega) */}
